...
pub mod calls;
pub use calls::{
    argpromote, bind_all_call_args, bind_call_args, compute_call_clobbered_regs,
    compute_clobbered_regs, compute_input_regs, compute_saved_regs, compute_stack_delta,
    learn_stack_facts, resolve_arg_loads, seed_stack_facts, set_all_call_clobbered_regs,
...
pub use dce::{
    ...
    remove_dead_load_insns_block, remove_entry_param,
};
