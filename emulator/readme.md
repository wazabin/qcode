...
A concrete interpreter for the [QCode](https://docs.rs/qcode) IR.
...
[`qcode_jit`](https://docs.rs/qcode_jit) is checked against.
...
[`qcode_vm`](https://docs.rs/qcode_vm), which layers those on top of this
crate.
